class Game extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet("ShiftKey", "Keys/Shift-Key.png", {
      frameWidth: 48,
      frameHeight: 32,
    });
    this.load.spritesheet("SpaceKey", "Keys/Space-Key.png", {
      frameWidth: 64,
      frameHeight: 32,
    });
    this.load.spritesheet("CoolKey", "Keys/Cool-Key.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    this.load.spritesheet("SendKey", "Keys/Enter-Key.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
  }
  ...
  createKey(key, xpos, ypos, xsize, ysize) {
    ...
    this.anims.create({
      key: key + "Key",
      frames: this.anims.generateFrameNumbers(key + "Key", {
        start: 1,
        end: 0,
      }),
      frameRate: 20,
